...
public class CustomerController {
	 ...
	 *
	 * This endpoint handles the registration of a new customer using the provided
	 * details. It expects a valid customer DTO (data transfer object) containing
	 * the necessary customer information such as email, name, and other details.
	 * 
	 * @param customerDTO the customer data transfer object containing the
	 *                    registration information
	 * @return ResponseEntity containing the newly created Customer object, with
	 *         HTTP status CREATED (201) if the registration is successful, or
	 *         throws an exception if there is an error during registration.
	 */
