...
/**
 * Utility class for retrieving user-related information from the security context.
 * This class contains helper methods to access details of the currently logged-in user, 
 * such as the username, in a Spring Security-based application.
 * @author rifat.bano
 */
public class UserUtil {
     ...
     * 
     * This method extracts the username of the authenticated user from the Spring Security context.
     * If the user is authenticated and the authentication details are available, the method will return
     * the username. If the authentication details are not available or the user is not authenticated, 
     * it returns null.
     * 
