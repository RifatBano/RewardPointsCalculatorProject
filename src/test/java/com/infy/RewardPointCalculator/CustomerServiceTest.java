 ...
 * <p>
 * This class tests various functionalities of the CustomerService, including customer registration,
 * loading user details by username, and logging out a user.
 * </p>
 */
...
public class CustomerServiceTest {
	...
	/**
     * Sets up test data before each test is executed.
     * Initializes a {@link CustomerDTO} and {@link Customer} object with valid test data.
     */
	@BeforeEach
	public void setUp() {
	...
	/**
     * Tests the customer registration functionality.
     * This test simulates a successful customer registration process where
     * the customer is saved in the repository and returned.
     * 
	...
	/**
     * Tests the customer registration functionality when the email is already in use.
     * This test simulates a scenario where the customer’s email is already present in the system,
     * causing a {@link DataIntegrityViolationException} to be thrown.
     * 
     * @throws Exception If there is any exception during the test execution
     */
	@Test
	public void testRegister_EmailAlreadyInUse() {
	 ...
	 /**
     * Tests the functionality of loading user details by username (email).
     * This test simulates a successful search for a customer by email in the repository.
     * 
     * @throws Exception If there is any exception during the test execution
     */
	@Test
	...
	/**
     * Tests the logout functionality by successfully invalidating a valid JWT token.
     * This test simulates extracting the username from a valid token and adding it to the blacklist.
     * 
     * @throws Exception If there is any exception during the test execution
     */
	@Test
	...
	/**
     * Tests the logout functionality when an invalid token is provided.
     * This test simulates the case where the token is invalid, causing an exception to be thrown.
     * 
     * @throws Exception If there is any exception during the test execution
     */
	@Test
