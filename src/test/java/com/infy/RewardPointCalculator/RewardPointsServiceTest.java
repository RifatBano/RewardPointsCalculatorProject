 ...
 * <p>
 * These tests cover the functionality of the RewardPointsService, ensuring that the methods for 
 * retrieving reward points for customers are working as expected, including cases where errors occur.
 * </p>
 */
public class RewardPointsServiceTest {
    ...
    /**
     * Test case for successfully retrieving aggregated reward points for a specific customer, month, and year.
     * <p>
     * This test verifies that the service correctly aggregates the reward points for a given customer and period,
     * by summing the points for all transactions.
     * </p>
     */    
    @Test
    public void testGetRewardPoints_Success() {
        when(customerRepository.findById(1L)).thenReturn(Optional.of(customer));
        when(rewardPointsRepository.findByCustomerAndMonthAndYear(customer, 1, 2025)).thenReturn(Arrays.asList(rewardPoints1, rewardPoints2));
    ...
    /**
     * Test case when no reward points are found for a given customer, month, and year.
     * <p>
     * This test checks that when no points are found, the service returns a RewardPoints object with 0 points.
     * </p>
     */    
    @Test
     ...
     * <p>
     * This test ensures that when a customer with the given ID does not exist, a ResponseStatusException is thrown
    ...
    /**
     * Test case for successfully retrieving all reward points for a specific customer.
     * <p>
     * This test ensures that the service correctly retrieves all reward points associated with a given customer.
     * </p>
     */
    @Test
     ...
     * <p>
     * This test ensures that the service returns an empty list when no reward points are found for a customer.
     * </p>
     */
    @Test
     ...
     * <p>
     * This test checks that when a customer is not found, a ResponseStatusException is thrown with an appropriate message.
     * </p>
     */
    @Test
    ...
    /**
     * Test case when a DataIntegrityViolationException occurs while retrieving reward points.
     * <p>
     * This test checks that when a data integrity violation occurs, the service throws a ResponseStatusException
     * with a BAD_REQUEST status and an appropriate error message.
     * </p>
     */
    @Test
    ...
    /**
     * Test case when a DataIntegrityViolationException occurs while retrieving all reward points.
     * <p>
     * This test checks that when a data integrity violation occurs, the service throws a ResponseStatusException
     * with a BAD_REQUEST status and an appropriate error message.
     * </p>
